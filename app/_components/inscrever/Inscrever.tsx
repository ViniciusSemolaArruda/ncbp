...
export default function Inscrever({ onSubmit, className, initial }: InscreverProps) {
  ...
  const validate = (): boolean => {
    ...
    // formato comum: 06/77409 (2 dígitos / 4-6 dígitos). Mantém flexível.
      ...
      <form className={styles.form} onSubmit={handleSubmit} noValidate>
        ...
        <div className={styles.terms}>
          <label className={styles.termsLabel}>
            ...
            />
            <span>
              Li os <a href="/termos" target="_blank" rel="noopener noreferrer">termos de uso</a> e a{" "}
              <a href="/privacidade" target="_blank" rel="noopener noreferrer">política de privacidade</a> e estou de acordo.
            </span>
          </label>
