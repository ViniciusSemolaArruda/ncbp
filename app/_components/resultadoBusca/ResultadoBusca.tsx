...
export default function ResultadoBusca({
  ...
  // Dedup por id para evitar keys repetidas (ex.: "juliana" duplicado)
  ...
  return (
    <section className={`${styles.wrap} ${className ?? ""}`}>
      ...
      {safeItems.map((p, i) => {
        ...
        const key = `${(p.id || p.nome).toLowerCase()}-${i}`;
            ...
            <div className={styles.right}>
              ...
              {p.temas?.length ? (
                <div className={styles.chips}>
                  {p.temas.map((t, idx) => (
                    <span key={`${t}-${idx}`} className={styles.chip}>
                      {t}
                    </span>
                  ))}
                </div>
              ...
              {p.sobre && (
                <div className={styles.sobre}>
                  ...
                  <p className={styles.bio} title={p.sobre}>
                    {p.sobre}
                  </p>
                </div>
              )}
